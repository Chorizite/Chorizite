...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiIOPtr
    {
        ...
        public ImGuiConfigFlags ConfigFlags { get { return NativePtr->ConfigFlags; } set { NativePtr->ConfigFlags = value; } }
        public ImGuiBackendFlags BackendFlags { get { return NativePtr->BackendFlags; } set { NativePtr->BackendFlags = value; } }
        public Vector2 DisplaySize { get { return NativePtr->DisplaySize; } set { NativePtr->DisplaySize = value; } }
        public float DeltaTime { get { return NativePtr->DeltaTime; } set { NativePtr->DeltaTime = value; } }
        public float IniSavingRate { get { return NativePtr->IniSavingRate; } set { NativePtr->IniSavingRate = value; } }
        ...
        public float FontGlobalScale { get { return NativePtr->FontGlobalScale; } set { NativePtr->FontGlobalScale = value; } }
        public bool FontAllowUserScaling { get { return NativePtr->FontAllowUserScaling == 1; } set { NativePtr->FontAllowUserScaling = value ? (byte)1 : (byte)0; } }
        public ImFontPtr FontDefault => new ImFontPtr(NativePtr->FontDefault);
        public Vector2 DisplayFramebufferScale { get { return NativePtr->DisplayFramebufferScale; } set { NativePtr->DisplayFramebufferScale = value; } }
        public bool ConfigDockingNoSplit { get { return NativePtr->ConfigDockingNoSplit == 1; } set { NativePtr->ConfigDockingNoSplit = value ? (byte)1 : (byte)0; } }
        public bool ConfigDockingWithShift { get { return NativePtr->ConfigDockingWithShift == 1; } set { NativePtr->ConfigDockingWithShift = value ? (byte)1 : (byte)0; } }
        public bool ConfigDockingAlwaysTabBar { get { return NativePtr->ConfigDockingAlwaysTabBar == 1; } set { NativePtr->ConfigDockingAlwaysTabBar = value ? (byte)1 : (byte)0; } }
        public bool ConfigDockingTransparentPayload { get { return NativePtr->ConfigDockingTransparentPayload == 1; } set { NativePtr->ConfigDockingTransparentPayload = value ? (byte)1 : (byte)0; } }
        public bool ConfigViewportsNoAutoMerge { get { return NativePtr->ConfigViewportsNoAutoMerge == 1; } set { NativePtr->ConfigViewportsNoAutoMerge = value ? (byte)1 : (byte)0; } }
        public bool ConfigViewportsNoTaskBarIcon { get { return NativePtr->ConfigViewportsNoTaskBarIcon == 1; } set { NativePtr->ConfigViewportsNoTaskBarIcon = value ? (byte)1 : (byte)0; } }
        public bool ConfigViewportsNoDecoration { get { return NativePtr->ConfigViewportsNoDecoration == 1; } set { NativePtr->ConfigViewportsNoDecoration = value ? (byte)1 : (byte)0; } }
        public bool ConfigViewportsNoDefaultParent { get { return NativePtr->ConfigViewportsNoDefaultParent == 1; } set { NativePtr->ConfigViewportsNoDefaultParent = value ? (byte)1 : (byte)0; } }
        public bool MouseDrawCursor { get { return NativePtr->MouseDrawCursor == 1; } set { NativePtr->MouseDrawCursor = value ? (byte)1 : (byte)0; } }
        public bool ConfigMacOSXBehaviors { get { return NativePtr->ConfigMacOSXBehaviors == 1; } set { NativePtr->ConfigMacOSXBehaviors = value ? (byte)1 : (byte)0; } }
        public bool ConfigInputTrickleEventQueue { get { return NativePtr->ConfigInputTrickleEventQueue == 1; } set { NativePtr->ConfigInputTrickleEventQueue = value ? (byte)1 : (byte)0; } }
        public bool ConfigInputTextCursorBlink { get { return NativePtr->ConfigInputTextCursorBlink == 1; } set { NativePtr->ConfigInputTextCursorBlink = value ? (byte)1 : (byte)0; } }
        public bool ConfigInputTextEnterKeepActive { get { return NativePtr->ConfigInputTextEnterKeepActive == 1; } set { NativePtr->ConfigInputTextEnterKeepActive = value ? (byte)1 : (byte)0; } }
        public bool ConfigDragClickToInputText { get { return NativePtr->ConfigDragClickToInputText == 1; } set { NativePtr->ConfigDragClickToInputText = value ? (byte)1 : (byte)0; } }
        public bool ConfigWindowsResizeFromEdges { get { return NativePtr->ConfigWindowsResizeFromEdges == 1; } set { NativePtr->ConfigWindowsResizeFromEdges = value ? (byte)1 : (byte)0; } }
        public bool ConfigWindowsMoveFromTitleBarOnly { get { return NativePtr->ConfigWindowsMoveFromTitleBarOnly == 1; } set { NativePtr->ConfigWindowsMoveFromTitleBarOnly = value ? (byte)1 : (byte)0; } }
        public float ConfigMemoryCompactTimer { get { return NativePtr->ConfigMemoryCompactTimer; } set { NativePtr->ConfigMemoryCompactTimer = value; } }
        public float MouseDoubleClickTime { get { return NativePtr->MouseDoubleClickTime; } set { NativePtr->MouseDoubleClickTime = value; } }
        public float MouseDoubleClickMaxDist { get { return NativePtr->MouseDoubleClickMaxDist; } set { NativePtr->MouseDoubleClickMaxDist = value; } }
        public float MouseDragThreshold { get { return NativePtr->MouseDragThreshold; } set { NativePtr->MouseDragThreshold = value; } }
        public float KeyRepeatDelay { get { return NativePtr->KeyRepeatDelay; } set { NativePtr->KeyRepeatDelay = value; } }
        public float KeyRepeatRate { get { return NativePtr->KeyRepeatRate; } set { NativePtr->KeyRepeatRate = value; } }
        public bool ConfigDebugBeginReturnValueOnce { get { return NativePtr->ConfigDebugBeginReturnValueOnce == 1; } set { NativePtr->ConfigDebugBeginReturnValueOnce = value ? (byte)1 : (byte)0; } }
        public bool ConfigDebugBeginReturnValueLoop { get { return NativePtr->ConfigDebugBeginReturnValueLoop == 1; } set { NativePtr->ConfigDebugBeginReturnValueLoop = value ? (byte)1 : (byte)0; } }
        public bool ConfigDebugIgnoreFocusLoss { get { return NativePtr->ConfigDebugIgnoreFocusLoss == 1; } set { NativePtr->ConfigDebugIgnoreFocusLoss = value ? (byte)1 : (byte)0; } }
        public bool ConfigDebugIniSettings { get { return NativePtr->ConfigDebugIniSettings == 1; } set { NativePtr->ConfigDebugIniSettings = value ? (byte)1 : (byte)0; } }
        ...
        public IntPtr GetClipboardTextFn { get { return NativePtr->GetClipboardTextFn; } set { NativePtr->GetClipboardTextFn = value; } }
        public IntPtr SetClipboardTextFn { get { return NativePtr->SetClipboardTextFn; } set { NativePtr->SetClipboardTextFn = value; } }
        public IntPtr ClipboardUserData { get => (IntPtr)NativePtr->ClipboardUserData; set => NativePtr->ClipboardUserData = (void*)value; }
        public IntPtr SetPlatformImeDataFn { get { return NativePtr->SetPlatformImeDataFn; } set { NativePtr->SetPlatformImeDataFn = value; } }
        public IntPtr _UnusedPadding { get => (IntPtr)NativePtr->_UnusedPadding; set => NativePtr->_UnusedPadding = (void*)value; }
        public bool WantCaptureMouse { get { return NativePtr->WantCaptureMouse == 1; } set { NativePtr->WantCaptureMouse = value ? (byte)1 : (byte)0; } }
        public bool WantCaptureKeyboard { get { return NativePtr->WantCaptureKeyboard == 1; } set { NativePtr->WantCaptureKeyboard = value ? (byte)1 : (byte)0; } }
        public bool WantTextInput { get { return NativePtr->WantTextInput == 1; } set { NativePtr->WantTextInput = value ? (byte)1 : (byte)0; } }
        public bool WantSetMousePos { get { return NativePtr->WantSetMousePos == 1; } set { NativePtr->WantSetMousePos = value ? (byte)1 : (byte)0; } }
        public bool WantSaveIniSettings { get { return NativePtr->WantSaveIniSettings == 1; } set { NativePtr->WantSaveIniSettings = value ? (byte)1 : (byte)0; } }
        public bool NavActive { get { return NativePtr->NavActive == 1; } set { NativePtr->NavActive = value ? (byte)1 : (byte)0; } }
        public bool NavVisible { get { return NativePtr->NavVisible == 1; } set { NativePtr->NavVisible = value ? (byte)1 : (byte)0; } }
        public float Framerate { get { return NativePtr->Framerate; } set { NativePtr->Framerate = value; } }
        public int MetricsRenderVertices { get { return NativePtr->MetricsRenderVertices; } set { NativePtr->MetricsRenderVertices = value; } }
        public int MetricsRenderIndices { get { return NativePtr->MetricsRenderIndices; } set { NativePtr->MetricsRenderIndices = value; } }
        public int MetricsRenderWindows { get { return NativePtr->MetricsRenderWindows; } set { NativePtr->MetricsRenderWindows = value; } }
        public int MetricsActiveWindows { get { return NativePtr->MetricsActiveWindows; } set { NativePtr->MetricsActiveWindows = value; } }
        public int MetricsActiveAllocations { get { return NativePtr->MetricsActiveAllocations; } set { NativePtr->MetricsActiveAllocations = value; } }
        public Vector2 MouseDelta { get { return NativePtr->MouseDelta; } set { NativePtr->MouseDelta = value; } }
        ...
        public Vector2 MousePos { get { return NativePtr->MousePos; } set { NativePtr->MousePos = value; } }
        public RangeAccessor<bool> MouseDown => new RangeAccessor<bool>(NativePtr->MouseDown, 5);
        public float MouseWheel { get { return NativePtr->MouseWheel; } set { NativePtr->MouseWheel = value; } }
        public float MouseWheelH { get { return NativePtr->MouseWheelH; } set { NativePtr->MouseWheelH = value; } }
        public ImGuiMouseSource MouseSource { get { return NativePtr->MouseSource; } set { NativePtr->MouseSource = value; } }
        public uint MouseHoveredViewport { get { return NativePtr->MouseHoveredViewport; } set { NativePtr->MouseHoveredViewport = value; } }
        public bool KeyCtrl { get { return NativePtr->KeyCtrl == 1; } set { NativePtr->KeyCtrl = value ? (byte)1 : (byte)0; } }
        public bool KeyShift { get { return NativePtr->KeyShift == 1; } set { NativePtr->KeyShift = value ? (byte)1 : (byte)0; } }
        public bool KeyAlt { get { return NativePtr->KeyAlt == 1; } set { NativePtr->KeyAlt = value ? (byte)1 : (byte)0; } }
        public bool KeySuper { get { return NativePtr->KeySuper == 1; } set { NativePtr->KeySuper = value ? (byte)1 : (byte)0; } }
        public ImGuiKey KeyMods { get { return NativePtr->KeyMods; } set { NativePtr->KeyMods = value; } }
        public RangeAccessor<ImGuiKeyData> KeysData => new RangeAccessor<ImGuiKeyData>(&NativePtr->KeysData_0, 652);
        public bool WantCaptureMouseUnlessPopupClose { get { return NativePtr->WantCaptureMouseUnlessPopupClose == 1; } set { NativePtr->WantCaptureMouseUnlessPopupClose = value ? (byte)1 : (byte)0; } }
        public Vector2 MousePosPrev { get { return NativePtr->MousePosPrev; } set { NativePtr->MousePosPrev = value; } }
        ...
        public bool MouseWheelRequestAxisSwap { get { return NativePtr->MouseWheelRequestAxisSwap == 1; } set { NativePtr->MouseWheelRequestAxisSwap = value ? (byte)1 : (byte)0; } }
        ...
        public float PenPressure { get { return NativePtr->PenPressure; } set { NativePtr->PenPressure = value; } }
        public bool AppFocusLost { get { return NativePtr->AppFocusLost == 1; } set { NativePtr->AppFocusLost = value ? (byte)1 : (byte)0; } }
        public bool AppAcceptingEvents { get { return NativePtr->AppAcceptingEvents == 1; } set { NativePtr->AppAcceptingEvents = value ? (byte)1 : (byte)0; } }
        public sbyte BackendUsingLegacyKeyArrays { get { return NativePtr->BackendUsingLegacyKeyArrays; } set { NativePtr->BackendUsingLegacyKeyArrays = value; } }
        public bool BackendUsingLegacyNavInputArray { get { return NativePtr->BackendUsingLegacyNavInputArray == 1; } set { NativePtr->BackendUsingLegacyNavInputArray = value ? (byte)1 : (byte)0; } }
        public ushort InputQueueSurrogate { get { return NativePtr->InputQueueSurrogate; } set { NativePtr->InputQueueSurrogate = value; } }
