...
namespace ImGuiNET
{
    ...
    public unsafe partial struct StbUndoStatePtr
    {
        ...
        public short undo_point { get { return NativePtr->undo_point; } set { NativePtr->undo_point = value; } }
        public short redo_point { get { return NativePtr->redo_point; } set { NativePtr->redo_point = value; } }
        public int undo_char_point { get { return NativePtr->undo_char_point; } set { NativePtr->undo_char_point = value; } }
        public int redo_char_point { get { return NativePtr->redo_char_point; } set { NativePtr->redo_char_point = value; } }
    }
}
